		...
		public void postHandle(HttpServletRequest request,HttpServletResponse response,Object handler,ModelAndView modelAndView)throws Exception{
		   ...
		   */
		   public boolean preHandle(HttpServletRequest request,HttpServletResponse response,Object handler)throws Exception{
		       ...
		       if(url.indexOf("getUser.do")>=0||url.indexOf("beforeRegister.do")>=0||url.indexOf("addUser.do")>=0||url.indexOf("firstView.do")>=0||url.indexOf("resetUser.do")>=0||url.indexOf("findHotNoteList.do")>=0||url.indexOf("findNoteList.do")>=0||url.indexOf("findHotFileList.do")>=0||url.indexOf("findPassword.do")>=0||url.indexOf("updatePassword.do")>=0){
		           return true;
		        }
				//获取Session
